...
var language = {
        ...
        ZH: {
                //<!--登录界面-->
                lp_login_activity_text1: "选择登录方式",
                lp_login_activity_cs_text: "联络客服",
                lp_login_activity_facebook_text: "facebook",
                lp_login_activity_sw_text: "试玩",
                lp_login_activity_pt_text: "平台登录",
                lp_login_activity_google_text: "google",
                lp_login_activity_xieding: "商业协定",
                lp_login_activity_yinsi: "隐私政策",
                lp_login_activity_version: "版本",
                lp_login_activity_tip_title: "公告",
                lp_login_activity_but_enter: "进入游戏",
                //<!--切换账号界面-->
                lp_sdk_login_activity_tips_msg: "正在登录",
                lp_sdk_login_activity_tips_switch_msg: "切换账号",

                //<!--账号登录界面-->
                lp_platform_login_activity_login_title: "账号登录",
                lp_platform_login_activity_retrieve_password_txt: "忘记密码 ?",
                lp_platform_login_activity_btn_enter: "登录",
                lp_platform_login_activity_register: "点我注册账号",
                lp_platform_login_activity_account_manager: "账号管理",
                lp_platform_login_activity_login_hint_password: "密码",
                lp_platform_login_account_hint: "账号（邮箱/手机号码）",

                //<!-- 注册界面-->
                lp_register_activity_register_txt: "账号注册",
                lp_register_activity_agree_rule: "同意会员服务",
                lp_register_activity_rule_manage: "《会员管理规章》",
                lp_register_activity_register_but: "注  册",
                lp_register_activity_hint_username: "账号：手机号/Email",
                lp_register_activity_hint_password: "密码",
                lp_register_activity_hint_reppassword: "重复密码",
                lp_register_activity_hint_email: "Email(可用于找回密码)",



                //<!-- 找回密码界面-->
                lp_retrieve_password_activity_title: "忘记密码 ?",
                lp_retrieve_password_activity_hint_acc: "账号",
                lp_retrieve_password_activity_hint_email: "注册Email",
                lp_retrieve_password_activity_retrieve_pwd: "找回密码",


                //<!--平台登陆提示-->
                lp_login_code_account_empty: "登录账号不能为空",
                lp_login_code_password_empty: "登录密码不能为空",
                lp_login_code_checkaccount: "帐号只能是3-32位数字或字母（区分大小写）开头+数字字母的邮箱，\n及3-32位数字组成的手机号",
                lp_login_code_checkapassword: "请输入6-20位数字或字母组合的密码",

                //<!-- 注册代码部分 -->
                lp_register_code_account_empty: "注册账号不能为空",
                lp_register_code_password_empty: "注册密码不能为空",
                lp_register_code_reppassword_empty: "重複密码不能为空",
                lp_register_code_email_empty: "注册邮箱不能为空",
                lp_register_code_checkaccount: "帐号只能是3-32位数字或字母（区分大小写）开头+数字字母的邮箱，\n及3-32位数字组成的手机号",
                lp_register_code_checkapassword: "请输入6-20位数字或字母组合的密码",
                lp_register_code_checkpwrep: "密码与重複密码不一致",
                lp_register_code_checkemail: "您输入的邮箱格式不正确",
                lp_register_code_agreerule: "请勾选同意协议",


                //<!-- 找回密码代码部分 -->
                lp_getpassword_code_account_empty: "账号不能为空",
                lp_getpassword_code_email_empty: "邮箱不能为空",
                lp_getpassword_code_account_fomat: "帐号只能是3-32位数字或字母（区分大小写）开头+数字字母的邮箱，\n及3-32位数字组成的手机号",
                lp_getpassword_code_email_fomat: "邮箱格式不对",
                //<!-- 账号管理 -->

                lp_accountmanage_txt_return: "返  回",
                lp_accountmanage_txt_service: "联系客服",
                lp_account_manage_activity_update_psw: "修改密码",
                lp_account_manage_activity_guest_binding: "试玩绑定",
                lp_account_manage_activity_facebook_binding: "Facebook账号绑定",
                lp_account_manage_activity_google_binding: "G+账号绑定",
                //<!-- 修改密码 -->
                lp_updatepassword_txt_updatepassword: "修改密码",
                lp_updatepassword_txt_return: "返  回",
                lp_updatepassword_txt_account: "账号",
                lp_updatepassword_txt_oldpassword: "原始密码",
                lp_updatepassword_txt_newpassword: "新密码",
                lp_updatepassword_txt_reppassword: "确认密码",
                lp_updatepassword_btn_updatepassword: "确认修改",
                //<!-- 修改密码代码部分 -->
                lp_updatepassword_code_account_empty: "账号不能为空",
                lp_updatepassword_code_account_format: "帐号只能是3-32位数字或字母（区分大小写）开头+数字字母的邮箱，\n及3-32位数字组成的手机号",
                lp_updatepassword_code_oldpasswod_empty: "原密码不能为空",
                lp_updatepassword_code_password_format: "请输入6-20位数字或字母组合的密码",
                lp_updatepassword_code_newpassword_empty: "新密码不能为空",
                lp_updatepassword_code_reppassword_empty: "确认密码不能为空",
                lp_updatepassword_code_pwnoeqrepw_empty: "密码与确认密码不一致",
                //<!-- 绑定账号 -->
                lp_accountbing_txt_title: "试玩绑定",
                lp_accountbing_btn_accountbing: "确认绑定",
                lp_accountbing_edt_username: "账号：手机号/Email",
                lp_accountbing_edt_password: "密  码",
                lp_accountbing_edt_reppassword: "重复密码",

                //<!-- 绑定账号代码部分 -->
                lp_accountbing_code_account_empty: "账号不能为空",
                lp_accountbing_code_account_format: "帐号只能是3-32位数字或字母（区分大小写）开头+数字字母的邮箱，\n及3-32位数字组成的手机号",
                lp_accountbing_code_passwod_empty: "密码不能为空",
                lp_accountbing_code_password_format: "请输入6-20位数字或字母组合的密码",
                lp_accountbing_code_email_empty: "邮箱不能为空",
                lp_accountbing_code_reppassword_empty: "确认密码不能为空",
                lp_accountbing_code_pwnoeqrepw_empty: "密码与确认密码不一致",
                lp_accountbing_code_email_format: "邮箱格式不正确",
                lp_account_manage_activity_title: "账号管理",
                lp_account_binding_activity_account_hint: "账号：手机号/Email",
                lp_account_binding_activity_old_psw_hint: "原始密码",
                lp_account_binding_activity_psw_hint: "密码",
                lp_account_binding_activity_repsw_hint: "确认密码",
                lp_account_binding_activity_guest: "试玩绑定",
                lp_account_binding_activity_facebook: "facebook绑定",
                lp_account_binding_activity_google: "google绑定",
                lp_account_binding_activity_up_psw: "修改密码",
                lp_account_binding_activity_up_text: "确认修改",
                lp_account_binding_activity_bind_text: "确认绑定",
                lp_account_binding_activity_warn: "温馨提醒：您的账号已绑定",
                lp_account_binding_activity_email_hint: "Email（可用于找回密码）",
                lp_account_binding_activity_email_confirm: "确定",
                lp_privacy_policy_activity_txt: "隐私政策",
                ...
                //<!--账号格式检查-->
                lp_account_empty: "账号不能为空",
                lp_password_empty: "密码不能为空",
                lp_check_account: "帐号只能是3-32位数字或字母（区分大小写）开头+数字字母的邮箱，\n及3-32位数字组成的手机号",
                lp_check_password: "请输入6-20位数字或字母组合的密码",
                lp_check_password_mismatch: "密码与重複密码不一致",
                lp_check_email: "您输入的邮箱格式不正确",

                //<!---->
                lp_tips_title: "提示",
                lp_tips_cancel: "取消",
                lp_tips_confirm: "确定",
                lp_login_switch_activity_del_msg: "删除此登录记录？",
                lp_permission_tips_setting_msg: "缺少必要权限点击取消退出，点击设置去开启权限",
                lp_permission_tips_cancel: "取消",
                lp_permission_tips_setting: "设定",
                lp_permission_tips_retry_msg: "缺少运行必要权限",
                lp_permission_tips_msg: "为了能正常使用此应用,请允许存储空间权限",
                lp_permission_tips_cancel_msg: "没有授权此应用存储权限,点击确定退出游戏,点击设定去开启权限",
                lp_permission_cancel: "取消",
                lp_permission_retry: "重试",
                lp_ping_tai_chu_zhi_activity_order_buy: "确定购买",
                lp_ping_tai_chu_zhi_activity_order_msg: "订单信息",
                lp_ping_tai_chu_zhi_activity_cs: "客服",
                lp_ping_tai_chu_zhi_activity_back: "返回",
                lp_zhi_fu_item_btn_text: "点我购买",
                lp_network_error: "链接服务器失败"
        }
};