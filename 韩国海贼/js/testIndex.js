            ...
            $(".Mol").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        let payUlMol_item = document.createElement("ul")
                        if (res.code === "003") {

                            for (let mol = 0; mol < res.cashFlowItemArray.length; mol++) {
                                let molList = mol
                            ...
                            for(let molItem = 0; molItem < res.cashFlowItemArray.length; molItem++){
                                let molItemIndex = molItem
