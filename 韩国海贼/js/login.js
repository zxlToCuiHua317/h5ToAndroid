                                                    ...
                                                    if (res.code === "1000") {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function success(res) {
                                                                ...
                                                                var timer = new Date().getTime();
                                                                getfbData[0].time = timer;
                                                                localStorage.setItem("fbLoginData", JSON.stringify(getfbData));
...
function loginCallback(siteCode, passport, t, c) {

    console.log("siteCode-------->" + siteCode);
    console.log("passport-------->" + passport);
    console.log("t-------->" + t);
    console.log("c-------->" + c);
    window.Callback.loginCallback(true, siteCode, passport, t, c);
}
var FBID = 0;
var accessToken = 0;
var FBName = "";
