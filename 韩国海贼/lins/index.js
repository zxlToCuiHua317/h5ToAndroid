...
function showPass(obj) {
  ...
  if (ret == "password") {
    pass.attr("type", "text");
    img.attr("src", "//awscdnfhzwkrtwo.7jw9xwp.com/gc_file/webLogin/login/img/ear.png");
  } else {
    pass.attr("type", "password");
    img.attr("src", "//awscdnfhzwkrtwo.7jw9xwp.com/gc_file/webLogin/login/img/ear_blue.png");
  }
  pass.val(temp);
}
              ...
              if (res.code === "1000") {
                ...
                $.ajax({
                  ...
                  success: function success(res) {
                    ...
                    localStorage.setItem("ptLoginData", JSON.stringify(getPtLoginData));
                    loginCallback(res.toGameInfo.sitecode, res.toGameInfo.passport, res.toGameInfo.t, res.toGameInfo.ck);
                  }
                });
              } else {
                alert(res.msg);
