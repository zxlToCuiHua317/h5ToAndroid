...
if (GetQueryString("gameCode")) {
    ...
    localStorage.getItem("gameData", JSON.stringify(gameData));
}
    ...
    $.ajax({
        ...
        success: function success(res) {
            ...
            if (res.code === "1000") {
                ...
                localStorage.getItem(getptLoginData_c, JSON.stringify(ptLoginData) || "[]");
        ...
        $.ajax({
            ...
            success: function success(res) {
                ...
                if (res.code === "1400") {
                    ...
                    localStorage.getItem("tryToGameData", JSON.stringify(tryToGameData));
                    isFirstLogin = 1;
                    localStorage.getItem("FirstLogin", isFirstLogin);
                    var time = new Date().getTime();
                    trydata = {
                        name: res.id,
                        id: res.id,
                    ...
                    localStorage.getItem(gettryLoginData_c, JSON.stringify(tryLoginData) || "[]");
            ...
            if (res.code === "1000") {
                $.ajax({
                    ...
                    success: function success(result) {
                        ...
                        accessToken = res.access_token;
                        isFbLogin = 1;
                        localStorage.getItem("FbLogin", isFbLogin);
                        if (res.code === "1000") {
                            ...
                            localStorage.getItem(getfbLoginData_c, JSON.stringify(fbLoginData) || "[]");
                        }
                    }
                });
            }
