...
$(".arrbtn").click(function () {
    if (leftShow) {
        ...
        isOpenRule = 1;
        localStorage.getItem("isOpenRule", isOpenRule);
    } else {
...
$("ul").on("click", ".item-down", function () {
    ...
    if (arrData[index].type === "fb") {
        if (window.confirm("是否要刪除該賬號記錄")) {
            ...
            localStorage.getItem("fbLoginData", JSON.stringify(getFbLoginData));
        ...
        if (window.confirm("是否要刪除該賬號記錄")) {
            ...
            localStorage.getItem("ptLoginData", JSON.stringify(getPtLoginData));
            console.log(arrData);
            console.log(getPtLoginData);
        ...
        if (window.confirm("是否要刪除該賬號記錄")) {
            ...
            localStorage.getItem("tryLoginData", JSON.stringify(getTryLoginData));
    ...
    if (isClick) {
        var _loop = function _loop(ch) {
            ...
            if (arrData[chindex].type === "pt") {
                ...
                if (arrData[chindex].name === username) {
                    getLogin(arrData[chindex].accessToken);
                }
                            ...
                            if (res.code === "1400") {
                                ...
                                $.ajax({
                                    ...
                                    success: function success(res) {
                                        ...
                                        var timer = new Date().getTime();
                                        arrData[chindex].time = timer;
                                        localStorage.getItem("tryLoginData", JSON.stringify([arrData[chindex]]));
                                        sendData = JSON.stringify(res);
                                        loginCallback(sendData);
                                    }
                                });
