const Check = {
    check_login_username: function () {
        ...
        switch (getLanguage) {
            ...
            case "English":
                ...
                break;
            case "VN":
                alert(language.VN.lp_account_empty)
                break;
            default:
                alert(language.VN.lp_account_empty)
                break;
    ...
    check_login_checkaccount: function () {
        getLanguage = GetQueryString("language")
        switch (getLanguage) {
            case "TW":
    ...
    check_login_checkapassword: function () {
        getLanguage = GetQueryString("language")
        switch (getLanguage) {
            case "TW":
    ...
    check_login_reppassword: function () {
        getLanguage = GetQueryString("language")
        switch (getLanguage) {
            case "TW":
