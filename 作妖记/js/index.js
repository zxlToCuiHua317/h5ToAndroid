...
function showPass(obj) {
    ...
    if (ret == 'password') {
        pass.attr("type", "text");
        img.attr("src", "//awscdnfzyjone.hkojfsl.com/gc_file/webLogin/login/img/ear.png");
    } else {
        pass.attr("type", "password");
        img.attr("src", "//awscdnfzyjone.hkojfsl.com/gc_file/webLogin/login/img/ear_blue.png");
    }
    pass.val(temp);
}
