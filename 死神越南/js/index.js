...
function showPass(obj) {
  ...
  if (ret == "password") {
    pass.attr("type", "text");
    img.attr("src", "//awscdnfssvnone.dsf700game.com/gc_file/webLogin/login/img/ear.png");
  } else {
    pass.attr("type", "password");
    img.attr("src", "//awscdnfssvnone.dsf700game.com/gc_file/webLogin/login/img/ear_blue.png");
  }
  pass.val(temp);
}
