...
$(function () {
            ...
            if (GetQueryString("language")) {
                        ...
                        getLanguage = JSON.parse(localStorage.getItem("gameData")).language;
            }
            ...
            switch (getLanguage) {
                        ...
                        case "KR":
                                    ...
                                    break;
                        case "English":
                                    $("#enter_game_ns").val(language.VN.lp_platform_login_activity_btn_enter);
                                    $(".handle_head_title").text(language.VN.lp_login_activity_text1);
                                    $(".handle_icon_facebook").text(language.VN.lp_login_activity_facebook_text);
                                    $(".handle_icon_sw").text(language.VN.lp_login_activity_sw_text);
                                    $(".handle_icon_pt").text(language.VN.lp_login_activity_pt_text);
                                    $("#login_username_ns").attr("placeholder", language.VN.lp_platform_login_account_hint);
                                    $("#login_userpassword_ns").attr("placeholder", language.VN.lp_platform_login_activity_login_hint_password);
                                    $(".login_button_ns").val(language.VN.lp_platform_login_activity_btn_enter);

                                    $(".forget_password_ns span").text(language.VN.lp_platform_login_activity_retrieve_password_txt);
                                    $(".click_registered_ns").text(language.VN.lp_platform_login_activity_register);
                                    $(".account_management_ns").text(language.VN.lp_platform_login_activity_account_manager);

                                    $("#retrieve_username_ns").attr("placeholder", language.VN.lp_retrieve_password_activity_hint_acc);
                                    $("#retrieve_email_ns").attr("placeholder", language.VN.lp_retrieve_password_activity_hint_email);
                                    $(".retrieve_password_ns").val(language.VN.lp_retrieve_password_activity_retrieve_pwd);

                                    $("#registered_username_ns").attr("placeholder", language.VN.lp_register_activity_hint_username);
                                    $("#registered_userpassword_ns").attr("placeholder", language.VN.lp_register_activity_hint_password);
                                    $("#registered_repeatpassword_ns").attr("placeholder", language.VN.lp_register_activity_hint_reppassword);
                                    $("#registered_email_ns").attr("placeholder", language.VN.lp_register_activity_hint_email);
                                    $(".registered_button_ns").val(language.VN.lp_register_activity_register_txt);

                                    $(".user_agree_rule").text(language.VN.lp_register_activity_agree_rule);
                                    $(".toRule").text(language.VN.lp_register_activity_rule_manage);

                                    $(".account1_ns").text(language.VN.lp_updatepassword_txt_updatepassword);
                                    $(".account2_ns").text(language.VN.lp_account_manage_activity_guest_binding);
                                    $(".account3_ns").text(language.VN.lp_account_manage_activity_facebook_binding);

                                    $("#changePass_phone_ns").attr("placeholder", language.VN.lp_accountbing_edt_username);
                                    $("#changePass_userpassword_ns").attr("placeholder", language.VN.lp_updatepassword_txt_oldpassword);
                                    $("#changePass_newpassword_ns").attr("placeholder", language.VN.lp_updatepassword_txt_newpassword);
                                    $("#changePass_repeatpassword_ns").attr("placeholder", language.VN.lp_updatepassword_txt_reppassword);
                                    $(".changePass_button_ns").val(language.VN.lp_updatepassword_btn_updatepassword);

                                    $("#play_username_ns").attr("placeholder", language.VN.lp_accountbing_edt_username);
                                    $("#play_userpassword_ns").attr("placeholder", language.VN.lp_accountbing_edt_password);
                                    $("#play_repeatpassword_ns").attr("placeholder", language.VN.lp_accountbing_edt_reppassword);
                                    $("#play_email_ns").attr("placeholder", language.VN.lp_account_binding_activity_email_hint);
                                    $(".play_button_ns").val(language.VN.lp_accountbing_btn_accountbing);

                                    $("#fb_username_ns").attr("placeholder", language.VN.lp_accountbing_edt_username);
                                    $("#fb_userpassword_ns").attr("placeholder", language.VN.lp_accountbing_edt_password);
                                    $("#fb_repeatpassword_ns").attr("placeholder", language.VN.lp_accountbing_edt_reppassword);
                                    $("#fb_email_ns").attr("placeholder", language.VN.lp_account_binding_activity_email_hint);
                                    $(".fb_button_ns").val(language.VN.lp_accountbing_btn_accountbing);

                                    $(".title_loding").text(language.VN.lp_sdk_login_activity_tips_msg);
                                    $(".quit_btn").text(language.VN.lp_sdk_login_activity_tips_switch_msg);
                                    break;
                        case "VI":
                                    $("#enter_game_ns").val(language.VI.lp_platform_login_activity_btn_enter);
                                    $(".handle_head_title").text(language.VI.lp_login_activity_text1);
                                    $(".handle_icon_facebook").text(language.VI.lp_login_activity_facebook_text);
                                    $(".handle_icon_sw").text(language.VI.lp_login_activity_sw_text);
                                    $(".handle_icon_pt").text(language.VI.lp_login_activity_pt_text);
                                    $("#login_username_ns").attr("placeholder", language.VI.lp_platform_login_account_hint);
                                    $("#login_userpassword_ns").attr("placeholder", language.VI.lp_platform_login_activity_login_hint_password);
                                    $(".login_button_ns").val(language.VI.lp_platform_login_activity_btn_enter);

                                    $(".forget_password_ns span").text(language.VI.lp_platform_login_activity_retrieve_password_txt);
                                    $(".click_registered_ns").text(language.VI.lp_platform_login_activity_register);
                                    $(".account_management_ns").text(language.VI.lp_platform_login_activity_account_manager);

                                    $("#retrieve_username_ns").attr("placeholder", language.VI.lp_retrieve_password_activity_hint_acc);
                                    $("#retrieve_email_ns").attr("placeholder", language.VI.lp_retrieve_password_activity_hint_email);
                                    $(".retrieve_password_ns").val(language.VI.lp_retrieve_password_activity_retrieve_pwd);

                                    $("#registered_username_ns").attr("placeholder", language.VI.lp_register_activity_hint_username);
                                    $("#registered_userpassword_ns").attr("placeholder", language.VI.lp_register_activity_hint_password);
                                    $("#registered_repeatpassword_ns").attr("placeholder", language.VI.lp_register_activity_hint_reppassword);
                                    $("#registered_email_ns").attr("placeholder", language.VI.lp_register_activity_hint_email);
                                    $(".registered_button_ns").val(language.VI.lp_register_activity_register_txt);

                                    $(".user_agree_rule").text(language.VI.lp_register_activity_agree_rule);
                                    $(".toRule").text(language.VI.lp_register_activity_rule_manage);

                                    $(".account1_ns").text(language.VI.lp_updatepassword_txt_updatepassword);
                                    $(".account2_ns").text(language.VI.lp_account_manage_activity_guest_binding);
                                    $(".account3_ns").text(language.VI.lp_account_manage_activity_facebook_binding);

                                    $("#changePass_phone_ns").attr("placeholder", language.VI.lp_accountbing_edt_username);
                                    $("#changePass_userpassword_ns").attr("placeholder", language.VI.lp_updatepassword_txt_oldpassword);
                                    $("#changePass_newpassword_ns").attr("placeholder", language.VI.lp_updatepassword_txt_newpassword);
                                    $("#changePass_repeatpassword_ns").attr("placeholder", language.VI.lp_updatepassword_txt_reppassword);
                                    $(".changePass_button_ns").val(language.VI.lp_updatepassword_btn_updatepassword);

                                    $("#play_username_ns").attr("placeholder", language.VI.lp_accountbing_edt_username);
                                    $("#play_userpassword_ns").attr("placeholder", language.VI.lp_accountbing_edt_password);
                                    $("#play_repeatpassword_ns").attr("placeholder", language.VI.lp_accountbing_edt_reppassword);
                                    $("#play_email_ns").attr("placeholder", language.VI.lp_account_binding_activity_email_hint);
                                    $(".play_button_ns").val(language.VI.lp_accountbing_btn_accountbing);

                                    $("#fb_username_ns").attr("placeholder", language.VI.lp_accountbing_edt_username);
                                    $("#fb_userpassword_ns").attr("placeholder", language.VI.lp_accountbing_edt_password);
                                    $("#fb_repeatpassword_ns").attr("placeholder", language.VI.lp_accountbing_edt_reppassword);
                                    $("#fb_email_ns").attr("placeholder", language.VI.lp_account_binding_activity_email_hint);
                                    $(".fb_button_ns").val(language.VI.lp_accountbing_btn_accountbing);

                                    $(".title_loding").text(language.VI.lp_sdk_login_activity_tips_msg);
                                    $(".quit_btn").text(language.VI.lp_sdk_login_activity_tips_switch_msg);
                                    break;
                        default:
                                    $("#enter_game_ns").val(language.TW.lp_platform_login_activity_btn_enter);
                                    $(".handle_head_title").text(language.TW.lp_login_activity_text1);
