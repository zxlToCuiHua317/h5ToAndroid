...
$(".arrbtn").click(function () {
  if (leftShow) {
    ...
    alert("Vui lòng kiểm tra chính sách bảo mật!!!");
  }
});
...
function showPass(obj) {
  ...
  if (ret == "password") {
    pass.attr("type", "text");
    img.attr("src", "//awscdnflzdeone.epedamz.com/gc_file/webLogin/login/img/ear.png");
  } else {
    pass.attr("type", "password");
    img.attr("src", "//awscdnflzdeone.epedamz.com/gc_file/webLogin/login/img/ear_blue.png");
  }
  pass.val(temp);
}
...
$("ul").on("click", ".item-down", function () {
  ...
  if (arrData[index].type === "fb") {
    if (window.confirm("Do you want to delete the account record")) {
...
$(".cuihua").on("click", ".item-title", function () {
