...
function showPass(obj) {
    ...
    if (ret == "password") {
        pass.attr("type", "text");
        img.attr("src", "//awscdnfbhkrone.hqeaotr.com/gc_file/webLogin/login/img/ear.png");
    } else {
        pass.attr("type", "password");
        img.attr("src", "//awscdnfbhkrone.hqeaotr.com/gc_file/webLogin/login/img/ear_blue.png");
    }
    pass.val(temp);
}
