...
function showPass(obj) {
    ...
    if (ret == "password") {
        pass.attr("type", "text");
        img.attr("src", "//awscdnfkdjxkrone.txxadth.com/gc_file/webLogin/login/img/ear.png");
    } else {
        pass.attr("type", "password");
        img.attr("src", "//awscdnfkdjxkrone.txxadth.com/gc_file/webLogin/login/img/ear_blue.png");
    }
    pass.val(temp);
}
...
var getHWTryLoginData = JSON.parse(localStorage.getItem("hwtryLoginData"));

console.log(getTryLoginData);
if (getFbLoginData.length === 0 && getPtLoginData.length === 0 && getTryLoginData.length === 0 && getHWTryLoginData.length === 0) {
    $(".down_list").hide();
} else if (getFbLoginData && getPtLoginData && getTryLoginData) {
    console.log("三个数组都有");
    var arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getFbLoginData), _toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
    //根据对象里的时间排序
...
$("ul").on("click", ".item-down", function () {
    ...
    if (arrData[index].type === "fb") {
        if (window.confirm("삭제 하시겠습니까")) {
            ...
            if (getFbLoginData.length === 0) {
                getFbLoginData = [];
                if (getPtLoginData.length > 0 && getTryLoginData.length > 0 && getHWTryLoginData.length > 0) {
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
                    str = "";
                    ...
                    $(".down_list ul").html(str);
                } else if (getPtLoginData.length > 0 && getTryLoginData.length === 0 && getHWTryLoginData.length === 0) {
                    ...
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getHWTryLoginData));
                    str = "";
                    ...
                    arrData = [].concat(_toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
                    str = "";
                    ...
                    arrData = [].concat(_toConsumableArray(getHWTryLoginData));
                    str = "";

                    $(".sel-title").text(getHWTryLoginData[0].name);
                    $(".sel-img").removeClass("icon-Facebook").addClass(getHWTryLoginData[0].icon);
        ...
        if (window.confirm("삭제 하시겠습니까")) {
            ...
            if (getPtLoginData.length === 0) {
                getPtLoginData = [];
                str = "";
                if (getFbLoginData.length > 0 && getTryLoginData.length > 0 && getHWTryLoginData.length > 0) {
                    arrData = [].concat(_toConsumableArray(getFbLoginData), _toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
                    ...
                    $(".down_list ul").html(str);
                } else if (getFbLoginData.length > 0 && getTryLoginData.length === 0 && getHWTryLoginData.length === 0) {
                    arrData = [].concat(_toConsumableArray(getFbLoginData), _toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
                    $(".sel-title").text(arrData[0].name);
                    $(".sel-img").removeClass("icon-people").addClass(arrData[0].icon);
                    str = "";
                ...
                console.log("1");
                if (getFbLoginData.length > 0 && getPtLoginData && getTryLoginData.length > 0 && getHWTryLoginData > 0) {
                    str = "";
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getFbLoginData), _toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
                    $(".sel-title").text(arrData[0].name);
                    $(".sel-img").removeClass("icon-people").addClass(arrData[0].icon);
                    arrData.forEach(function (item, index) {
                        str += " <li class=\"item" + index + "\">\n                                        <span class=\"item-img iconfont " + item.icon + "\"></span>\n                                        <span class=\"item-title\">" + item.name + "</span>\n                                        <span class=\"item-down iconfont icon-shanchu\"></span>\n                                    </li>";
                    ...
                    $(".down_list ul").html(str);
                } else if (getFbLoginData.length === 0 && getPtLoginData && getTryLoginData.length > 0 && getHWTryLoginData > 0) {
                    str = "";
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getTryLoginData), _toConsumableArray(getHWTryLoginData));
                    $(".sel-title").text(arrData[0].name);
                    $(".sel-img").removeClass("icon-people").addClass(arrData[0].icon);
                    ...
                    str = "";
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getFbLoginData), _toConsumableArray(getHWTryLoginData));
                    $(".sel-title").text(arrData[0].name);
                    $(".sel-img").removeClass("icon-people").addClass(arrData[0].icon);
                    arrData.forEach(function (item, index) {
                        str += " <li class=\"item" + index + "\">\n                                        <span class=\"item-img iconfont " + item.icon + "\"></span>\n                                        <span class=\"item-title\">" + item.name + "</span>\n                                        <span class=\"item-down iconfont icon-shanchu\"></span>\n                                    </li>";
        ...
        if (window.confirm("삭제 하시겠습니까")) {
            ...
            if (getTryLoginData.length === 0) {
                getTryLoginData = [];
                if (getPtLoginData.length > 0 && getFbLoginData.length > 0 && getHWTryLoginData.length > 0) {
                    console.log(getPtLoginData);
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getFbLoginData), _toConsumableArray(getHWTryLoginData));
                    str = "";
                    ...
                    $(".down_list ul").html(str);
                } else if (getPtLoginData.length > 0 && getFbLoginData.length === 0 && getHWTryLoginData.length > 0) {
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getHWTryLoginData));
                    str = "";
                    ...
                    arrData = [].concat(_toConsumableArray(getFbLoginData), _toConsumableArray(getHWTryLoginData));
                    str = "";
                    ...
                    $(".sel-title").text(getHWTryLoginData[0].name);
                    $(".sel-img").removeClass("icon-94").addClass(getHWTryLoginData[0].icon);
    ...
    } else if (arrData[index].type === "hwLogin") {
        if (window.confirm("삭제 하시겠습니까")) {
            console.log(getHWTryLoginData[index]);

            var tryDelData = getHWTryLoginData.indexOf(arrData[index]);
            getHWTryLoginData.splice(tryDelData, 1);
            localStorage.setItem("hwtryLoginData", JSON.stringify(getHWTryLoginData));
            localStorage.removeItem("FirstHWLogin");

            if (getHWTryLoginData.length === 0) {
                getHWTryLoginData = [];
                if (getPtLoginData.length > 0 && getFbLoginData.length > 0 && getTryLoginData.length > 0) {
                    console.log(getPtLoginData);
                    ...
                    $(".down_list ul").html(str);
                } else if (getPtLoginData.length > 0 && getFbLoginData.length === 0 && getTryLoginData.length > 0) {
                    console.log(getPtLoginData);
                    arrData = [].concat(_toConsumableArray(getPtLoginData), _toConsumableArray(getTryLoginData));
                    str = "";
                    ...
                    $(".down_list ul").html("");
                    $(".sel-title").text("");
                    $(".sel-img").removeClass("icon-huawei");
                }
            }
            $(".down_list").hide();
            $(".sel-up").hide();
...
$("ul").on("click", ".item-title", function () {
    ...
    if (arrData[indexs].type === "fb") {
        ...
        $(".sel-up").hide();
        $(".sel-down").show();
    } else if (arrData[indexs].type === "hwLogin") {
        $(".sel-title").text(arrData[indexs].name);
        $(".sel-img").removeClass("icon-Facebook icon-people icon-94").addClass(arrData[indexs].icon);
        $(".down_list").hide();
        $(".sel-up").hide();
        $(".sel-down").show();
    }
...
$("#enter_game_ns").click(function () {
    ...
    if (isClick) {
        var _loop = function _loop(ch) {
            ...
            console.log(arrData[chindex].typename)
            console.log(arrData[chindex].name)
            if (arrData[chindex].type === "pt") {
                ...
                if (arrData[chindex].name === username) {
                    getGameData = JSON.parse(localStorage.getItem("gameData"));
            ...
            } else if (arrData[chindex].typename === "hwLogin") {
                if (arrData[chindex].name === username) {
                    huawei_login()
                }
            }
